            ...
            <div class="bottom">
                ...
                <form method="POST" id="login-form">
                    <div class="form-group" id="phonediv">
                        ...
                        <input type="number" class="form-control" id="phone" name="phone" placeholder="Enter your number" readonly required />
                    </div> 
                    <div class="form-group">
                     
                        <label for="">Password</label> 
                        <input type="password" class="form-control" id="password" name="password" placeholder="Enter your password" readonly required />
                    </div> 
                    <div class="form-group">
