                ...
                <form id="reg-form" method="post">
                    <div id="regDiv">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lname" id="lname" class="form-control"  placeholder="Enter your full name" required>
                        </div> 
                    
                        <div class="form-group">
                            <i class="la la-phone"></i> &nbsp &nbsp
                            <label for="">Phone</label> <br>
                            <input type="number" name="phone" id="phone" class="form-control"  placeholder="Enter your phone number" readonly required>
                        </div> 
                        <div class="form-group">
                            <i class="la la-at"></i> &nbsp &nbsp
                            <label for="">Email</label> <br>
                            <input type="email" name="email" id="email" class="form-control"  placeholder="Enter your email" readonly required>
                        </div>
                    ...
                    <div id="nextregDiv" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="password" class="form-control"  placeholder="Enter Password" readonly required />
                        </div> 
                        <div class="form-group">
                            <i class="la la-lock"></i> &nbsp &nbsp
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="transpin" class="form-control"  placeholder="Enter your transaction pin" required>
                        </div>  
                        <div class="form-group">
